...
## ტეგისთვის გაწერილი კლასი
### დავალება 4.22

მოცემულია html და css კოდები:

```html
<h1 class="one">ძირითადი სათაური</h1>
<p class="one">
	ლორემ იფსუმ დოლორ სით ამეთ, ეი ცუმ ნოსთერ აუდირე ფერციფითურ, ფერ თე ყუანდო ვერითუს. ცუმ თე ამეთ ფრომფთა ელეიფენდ. ვიდერერ სცაევოლა თემფორიბუს ეამ ნო. ნო სოლუთა ფჰაედრუმ ჰის.
</p>

<h3 class="one">მესამეხარისხოვანი სათური</h3>
<p class="one">
	ლორემ იფსუმ დოლორ სით ამეთ, ეი ცუმ ნოსთერ აუდირე ფერციფითურ, ფერ თე ყუანდო ვერითუს. ცუმ თე ამეთ ფრომფთა ელეიფენდ. ვიდერერ სცაევოლა თემფორიბუს ეამ ნო. ნო სოლუთა ფჰაედრუმ ჰის.
</p>
```
...
```
css კოდის საშუალებით ყველა h1 სათაური გაცენტრეთ, ყველა h3 სათაურის ზომა იყოს 40px, ხოლო ყველა აბზაცის სიგანე იყოს 500px და ფონტის ფერი შავი.


## მემკვიდრე სელექტორები და კლასები
### დავალება 4.23
...
```
ყვითლად გააფერადეთ one კლასის ელემენტებში არსებული ყველა b ტეგი.
...
```html
<div class="one">
	<h1>მთავარი სათური</h1>
	<p class="paragraph">
		აბზაცი <b>მუქი</b> ტექტით
	</p>
	
	<h2>მეორეხარისხოვანი სათაური</h2>
	<p>
		აბზაცი <i>დახრილი</i> ტექტით
	</p>
	<p class="paragraph">
		აბზაცი <b>მუქი</b> ტექტით
	</p>
...
```
მწვანედ გააფერადეთ ყველა one კლასის ელემენტების შიგნით არსებული paragraph კლასის ელემენტები.


### დავალება 4.25

მოცემულია html კოდი. იხილეთ დავალება 4.24:
